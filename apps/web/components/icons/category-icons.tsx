...
export function FoodIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 2a5 5 0 0 0-5 5c0 2 1.5 3.5 3 4.5V22h4v-10.5c1.5-1 3-2.5 3-4.5a5 5 0 0 0-5-5z" />
      <path d="M8 7a3 3 0 0 0 0 6" />
    </svg>
  );
}
...
export function TransportIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18 10l-1.7-4.3A2 2 0 0 0 14.4 4H9.6a2 2 0 0 0-1.9 1.7L6 10l-2.5 1.1C2.7 11.3 2 12.1 2 13v3c0 .6.4 1 1 1h2" />
...
export function ChildcareIcon(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function getCategoryIcon(slug: string): React.ComponentType<IconProps> {
  return categoryIcons[slug] || HeartIcon;
}
